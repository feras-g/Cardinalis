...
/*
    Generate a point sample from a sequence of low discrepancy 2d points

    @params N Number of samples
    @params i Index in sequence

    http://holger.dammertz.org/stuff/notes_HammersleyOnHemisphere.html
    
    Returns the point corresponding to the ith sample in the Hammersley sequence
*/
